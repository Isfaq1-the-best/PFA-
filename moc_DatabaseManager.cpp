...
QT_MOC_LITERAL(1, 16, 13), // "databaseError"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 5), // "error"
QT_MOC_LITERAL(4, 37, 11), // "recordSaved"
QT_MOC_LITERAL(5, 49, 13), // "BarcodeRecord"
QT_MOC_LITERAL(6, 63, 6) // "record"

    },
    "DatabaseManager\0databaseError\0\0error\0"
    "recordSaved\0BarcodeRecord\0record"
};
...
void DatabaseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->recordSaved((*reinterpret_cast< const BarcodeRecord(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (DatabaseManager::*)(const BarcodeRecord & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DatabaseManager::recordSaved)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void DatabaseManager::recordSaved(const BarcodeRecord & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
